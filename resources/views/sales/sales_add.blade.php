                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                ...
                                <li><a href="{{url('/invoiceAdd')}}"  ><i class="fa fa-repeat"></i></a>
                        ...
                        <div class="x_content">
                            ...
                            <br />
                            <form class="form-horizontal form-label-left" method="post" action="{{url('/invoiceAdd')}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <textarea autocomplete="off" class="form-control auto-complete" name="desc[]"  rows="3"  placeholder='Please Enter Description '>None</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <div id="discount">
                                        <input type="text" id="discounts" name="discount" class="form-control discount " value="0"   placeholder="Enter Discount Amount ">
                                    </div>
                                    </div>
                                </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <input type="text" id="income_sum" name="totalAmount" class="form-control"  readonly   placeholder="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="paidAmount" class="col-md-9 col-sm-9 col-xs-12">
                                            <input type="text"   name="paidAmount" class="form-control paidAmounts" placeholder="Please Enter Paid Amount ">
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="remainingAmount" readonly name="remainingAmount" class="form-control remainingAmounts" placeholder="Remaining Amount ">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 " >
                                        <input id="paidDate" class="form-control" placeholder="" type="date" name="paidDate" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12 " >
                                        <input  class="form-control" placeholder="" type="date" name="dateIssue" >
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 ">
                                        ...
                                        <button style="margin-left: 200px" type="submit" class="btn btn-success">Submit</button>
                                    </div>
                                </div>
...
//                var qty = "qty" + counter;
            items.append(' <div> <div class="form-group">\n' +
                ...
                '                                    <span class="required"> *</span></label>\n' +
                '                                    <div class="col-md-9 col-sm-9 col-xs-12">\n' +
                '                                        <textarea id="auto-completes" class="form-control auto-complete" name="desc[]"  rows="3" placeholder=\'Please Enter Description \'>None</textarea>\n' +
                '                                    </div>\n' +
                '                                </div>\n' +
                '\n' +
                '                                <div class="form-group">\n' +
