                ...
                <div class="col-md-8 col-md-offset-2  col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <br />
                            <form class="form-horizontal form-label-left" method="post" action="{{url('/printingCompanyAdd')}}" id="whereEntry">
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <button type="submit" style="margin-left: 110px;" class="btn btn-primary">Add Printing Company</button>
                                    </div>
                                </div>
