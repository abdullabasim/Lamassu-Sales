                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox">
                                ...
                                <li><a href="{{url('/printingAdd')}}"  ><i class="fa fa-repeat"></i></a>
                        ...
                        <div class="x_content">
                            ...
                            <br />
                            <form class="form-horizontal form-label-left" method="post" action="{{url('/printingAdd')}}" id="whereEntry">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <textarea class="form-control" name="note"  rows="3" placeholder='Please Enter Note '>{{old('note')}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <button type="submit" style="margin-left: 110px;" class="btn btn-primary">Add Printing</button>
                                    </div>
                                </div>
